...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('stores', '0007_alter_product_price_alter_product_quantity_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('MEMBERSHIP', 'Membership')], default='MEMBERSHIP', max_length=100, verbose_name='Membership Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=django.utils.datetime_safe.date.today, verbose_name='Start date of the payment period')),
